# Generated by Powerlevel10k configuration wizard on 2025-07-30 at 11:56 CEST.
...
#  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%16F╭─'
#  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%16F├─'
#  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%16F╰─'
  ...
  typeset -g POWERLEVEL9K_RULER_FOREGROUND=16
  ...
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='愛'

  ################################[ prompt_char: prompt symbol ]################################
  # Green prompt symbol if the last command succeeded.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=16
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=16
