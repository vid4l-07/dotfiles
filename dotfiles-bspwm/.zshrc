...
if [ -x /usr/bin/dircolors ]; then
    ...
    alias cat='/bin/batcat --color=auto'
...
function settarget(){
	ip_address=$1
	machine_name=$2
	echo "$ip_address $machine_name" > /home/vidikali/.config/bin/target
}
...
export PATH=$PATH:/home/vidikali/.spicetify
export PATH=$PATH:/root/.spicetify
export PATH=$PATH:/home/vidikali/.local/bin
